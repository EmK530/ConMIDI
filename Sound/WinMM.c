...
int WinMM_Setup(){
    ...
    if ((WinMM_midiOutLongMsg = (WM_5)GetProcAddress(WinMM_libHandle, "midiOutLongMsg")) == NULL){printf("GetProcAddress failed for WinMM midiOutLongMsg.\n");return 0;}
    if ((WinMM_midiOutPrepareHeader = (WM_5)GetProcAddress(WinMM_libHandle, "midiOutPrepareHeader")) == NULL){printf("GetProcAddress failed for WinMM midiOutPrepareHeader.\n");return 0;}
    if ((WinMM_midiOutUnprepareHeader = (WM_5)GetProcAddress(WinMM_libHandle, "midiOutUnprepareHeader")) == NULL){printf("GetProcAddress failed for WinMM midiOutUnprepareHeader.\n");return 0;}
